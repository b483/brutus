...
enum {
    ...
    FIGURE_ACTION_ENEMY_SPAWNING = 90,
    FIGURE_ACTION_ENEMY_REGROUPING = 91,
    FIGURE_ACTION_ENEMY_ADVANCING = 92,
    FIGURE_ACTION_ENEMY_ENGAGED = 93,
    FIGURE_ACTION_NATIVE_GOING_TO_MEETING_CENTER = 94,
    FIGURE_ACTION_NATIVE_RETURNING_FROM_MEETING = 95,
    FIGURE_ACTION_NATIVE_CREATED = 96,
    FIGURE_ACTION_NATIVE_ATTACKING = 97,
    FIGURE_ACTION_NATIVE_TRADER_GOING_TO_WAREHOUSE = 98,
    FIGURE_ACTION_NATIVE_TRADER_RETURNING = 99,
    FIGURE_ACTION_NATIVE_TRADER_CREATED = 100,
    FIGURE_ACTION_NATIVE_TRADER_AT_WAREHOUSE = 101,
    FIGURE_ACTION_BALLISTA_READY = 102,
