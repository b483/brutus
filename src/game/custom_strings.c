...
static custom_string all_strings[] = {
    ...
    {TR_HOTKEY_GO_TO_PROBLEM, "Go to problem"},
    ...
    {TR_EDITOR_TOP_MENU_CLEAR_EARTHQUAKE_POINTS, "Clear earthquakes"},
    {TR_EDITOR_SIDEBAR_BUTTON_GRASS_TOOLTIP, "Grass"},
    {TR_EDITOR_SIDEBAR_BUTTON_SMALL_SHRUB_TOOLTIP, "Small shrub"},
    {TR_EDITOR_SIDEBAR_BUTTON_MEDIUM_SHRUB_TOOLTIP, "Medium shrub"},
    {TR_EDITOR_SIDEBAR_BUTTON_LARGE_SHRUB_TOOLTIP, "Large shrub"},
    {TR_EDITOR_SIDEBAR_BUTTON_LARGEST_SHRUB_TOOLTIP, "Largest shrub"},
    ...
    {TR_EDITOR_SIDEBAR_BUTTON_SMALL_ROCK_TOOLTIP, "Small rock"},
    {TR_EDITOR_SIDEBAR_BUTTON_MEDIUM_ROCK_TOOLTIP, "Medium rock"},
    {TR_EDITOR_SIDEBAR_BUTTON_LARGE_ROCK_TOOLTIP, "Large rock"},
    ...
    {TR_EDITOR_TOOL_SUBMENU_SMALL_SHRUB, "Small shrub"},
    {TR_EDITOR_TOOL_SUBMENU_MEDIUM_SHRUB, "Medium shrub"},
    {TR_EDITOR_TOOL_SUBMENU_LARGE_SHRUB, "Large shrub"},
    {TR_EDITOR_TOOL_SUBMENU_LARGEST_SHRUB, "Largest shrub"},
    ...
    {TR_EDITOR_TOOL_SUBMENU_SMALL_ROCK, "Small rock"},
    {TR_EDITOR_TOOL_SUBMENU_MEDIUM_ROCK, "Medium rock"},
    {TR_EDITOR_TOOL_SUBMENU_LARGE_ROCK, "Large rock"},
    ...
    {TR_EDITOR_TOOL_SUBMENU_EARTHQUAKE_POINT_1, "Earthquake point 1}"},
    {TR_EDITOR_TOOL_SUBMENU_EARTHQUAKE_POINT_2, "Earthquake point 2}"},
    {TR_EDITOR_TOOL_SUBMENU_EARTHQUAKE_POINT_3, "Earthquake point 3}"},
    {TR_EDITOR_TOOL_SUBMENU_EARTHQUAKE_POINT_4, "Earthquake point 4}"},
    {TR_EDITOR_TOOL_SUBMENU_EARTHQUAKE_POINT_5, "Earthquake point 5}"},
    {TR_EDITOR_TOOL_SUBMENU_EARTHQUAKE_POINT_6, "Earthquake point 6}"},
    {TR_EDITOR_TOOL_SUBMENU_EARTHQUAKE_POINT_7, "Earthquake point 7}"},
    {TR_EDITOR_TOOL_SUBMENU_EARTHQUAKE_POINT_8, "Earthquake point 8}"},
    ...
    {TR_EDITOR_INVASION_TARGET_TYPE, "Target type:"},
    ...
    {TR_EDITOR_ENEMY_TYPE_BARBARIANS, "Barbarians"},
    {TR_EDITOR_ENEMY_TYPE_CARTHAGINIANS, "Carthaginians"},
    {TR_EDITOR_ENEMY_TYPE_BRITONS, "Britons"},
    {TR_EDITOR_ENEMY_TYPE_CELTS, "Celts"},
    {TR_EDITOR_ENEMY_TYPE_PICTS, "Picts"},
    {TR_EDITOR_ENEMY_TYPE_EGYPTIANS, "Egyptians"},
    {TR_EDITOR_ENEMY_TYPE_ETRUSCANS, "Etruscans"},
    {TR_EDITOR_ENEMY_TYPE_SAMNITES, "Samnites"},
    {TR_EDITOR_ENEMY_TYPE_GAULS, "Gauls"},
    {TR_EDITOR_ENEMY_TYPE_HELVETII, "Helvetii"},
    {TR_EDITOR_ENEMY_TYPE_HUNS, "Huns"},
    {TR_EDITOR_ENEMY_TYPE_GOTHS, "Goths"},
    {TR_EDITOR_ENEMY_TYPE_VISIGOTHS, "Visigoths"},
    {TR_EDITOR_ENEMY_TYPE_GRAECI, "Graeci"},
    {TR_EDITOR_ENEMY_TYPE_MACEDONIANS, "Macedonians"},
    {TR_EDITOR_ENEMY_TYPE_NUMIDIANS, "Numidians"},
    {TR_EDITOR_ENEMY_TYPE_PERGAMUM, "Pergamum"},
    {TR_EDITOR_ENEMY_TYPE_IBERIANS, "Iberians"},
    {TR_EDITOR_ENEMY_TYPE_JUDAEANS, "Judaeans"},
    {TR_EDITOR_ENEMY_TYPE_SELEUCIDS, "Seleucids"},
    {TR_EDITOR_NO_EARTHQUAKES, "No earthquakes"},
    {TR_EDITOR_EARTHQUAKES_SCHEDULED, "Earthquakes scheduled"},
    {TR_EDITOR_EARTHQUAKES_TITLE, "Earthquakes"},
    {TR_EDITOR_EARTHQUAKES_FREE_SLOT, "Free earthquake slot"},
    {TR_EDITOR_EDIT_EARTHQUAKE_TITLE, "Scheduling an earthquake"},
    {TR_EDITOR_EDIT_EARTHQUAKE_POINT, "Point"},
    {TR_EDITOR_EDIT_EARTHQUAKE_CANCEL, "Cancel earthquake"},
    ...
    {TR_ENEMY_TYPE_BARBARIAN, "A barbarian warrior"},
    {TR_ENEMY_TYPE_CARTHAGINIAN, "A Carthaginian soldier"},
    {TR_ENEMY_TYPE_BRITON, "A Briton"},
    {TR_ENEMY_TYPE_CELT, "Celtic warrior"},
    {TR_ENEMY_TYPE_PICT, "Pictish warrior"},
    {TR_ENEMY_TYPE_EGYPTIAN, "An Egyptian soldier"},
    {TR_ENEMY_TYPE_ETRUSCAN, "An Etruscan soldier"},
    {TR_ENEMY_TYPE_SAMNITE, "A Samnite soldier"},
    {TR_ENEMY_TYPE_GAUL, "Gaulish warrior"},
    {TR_ENEMY_TYPE_HELVETIUS, "A warrior of the Helvetii"},
    {TR_ENEMY_TYPE_HUN, "A Hun warrior"},
    {TR_ENEMY_TYPE_GOTH, "A Goth warrior"},
    {TR_ENEMY_TYPE_VISIGOTH, "A Visigoth warrior"},
    {TR_ENEMY_TYPE_GRAECUS, "A Greek soldier"},
    {TR_ENEMY_TYPE_MACEDONIAN, "A Macedonian soldier"},
    {TR_ENEMY_TYPE_NUMIDIAN, "A Numidian warrior"},
    {TR_ENEMY_TYPE_PERGAMUM, "A soldier from Pergamum"},
    {TR_ENEMY_TYPE_IBERIAN, "An Iberian warrior"},
    {TR_ENEMY_TYPE_JUDAEAN, "A Judaean warrior"},
    {TR_ENEMY_TYPE_SELEUCID, "A Seleucid soldier"},
    {TR_ENEMY_TYPE_LEGION, "Imperial soldier"},
    {TR_FIGURE_DESC_NOBODY, "Nobody"},
    {TR_FIGURE_DESC_IMMIGRANT, "Immigrant"},
    {TR_FIGURE_DESC_EMIGRANT, "Emigrant"},
    {TR_FIGURE_DESC_HOMELESS, "Homeless"},
    {TR_FIGURE_DESC_PATRICIAN, "Patrician"},
    {TR_FIGURE_DESC_CART_PUSHER, "Cart pusher"},
    {TR_FIGURE_DESC_CITIZEN, "Citizen"},
    {TR_FIGURE_DESC_BARBER, "Barber"},
    {TR_FIGURE_DESC_BATHS_WORKER, "Baths worker"},
    {TR_FIGURE_DESC_DOCTOR, "Doctor"},
    {TR_FIGURE_DESC_SURGEON, "Surgeon"},
    {TR_FIGURE_DESC_PRIEST, "Priest"},
    {TR_FIGURE_DESC_SCHOOL_CHILD, "School child"},
    {TR_FIGURE_DESC_TEACHER, "Teacher"},
    {TR_FIGURE_DESC_LIBRARIAN, "Librarian"},
    {TR_FIGURE_DESC_MISSIONARY, "Missionary"},
    {TR_FIGURE_DESC_ACTOR, "Actor"},
    {TR_FIGURE_DESC_GLADIATOR, "Gladiator"},
    {TR_FIGURE_DESC_LION_TAMER, "Lion tamer"},
    {TR_FIGURE_DESC_CHARIOTEER, "Charioteer"},
    {TR_FIGURE_HIPPODROME_HORSE, "Hippodrome horse"},
    {TR_FIGURE_DESC_TAX_COLLECTOR, "Tax collector"},
    {TR_FIGURE_DESC_ENGINEER, "Engineer"},
    {TR_FIGURE_DESC_FISHING_BOAT, "Fishing boat"},
    {TR_FIGURE_DESC_SEAGULLS, "Seagulls"},
    {TR_FIGURE_DESC_SHIPWRECK, "Shipwreck"},
    {TR_FIGURE_DESC_DOCKER, "Docker"},
    {TR_FIGURE_DESC_FLOTSAM, "Flotsam"},
    {TR_FIGURE_DESC_BALLISTA, "Ballista"},
    {TR_FIGURE_DESC_BOLT, "Bolt"},
    {TR_FIGURE_DESC_SENTRY, "Sentry"},
    {TR_FIGURE_DESC_JAVELIN, "Javelin"},
    {TR_FIGURE_DESC_PREFECT, "Prefect"},
    {TR_FIGURE_DESC_STANDARD_BEARER, "Standard bearer"},
    {TR_FIGURE_DESC_JAVELIN_THROWER, "Javelin thrower"},
    {TR_FIGURE_DESC_MOUNTED_AUXILIARY, "Mounted auxiliary"},
    {TR_FIGURE_DESC_LEGIONARY, "Legionary"},
    {TR_FIGURE_DESC_MARKET_BUYER, "Market buyer"},
    {TR_FIGURE_DESC_MARKET_TRADER, "Market trader"},
    {TR_FIGURE_DESC_DELIVERY_BOY, "Delivery boy"},
    {TR_FIGURE_DESC_WAREHOUSEMAN, "Warehouseman"},
    {TR_FIGURE_DESC_PROTESTOR, "Protestor"},
    {TR_FIGURE_DESC_CRIMINAL, "Criminal"},
    {TR_FIGURE_DESC_RIOTER, "Rioter"},
    {TR_FIGURE_DESC_CARAVAN_OF_MERCHANTS_FROM, "Caravan of merchants from"},
    {TR_FIGURE_DESC_MERCHANT_DONKEY_FROM, "Caravan of merchants from"},
    {TR_FIGURE_DESC_TRADE_SHIP_FROM, "Trade ship from"},
    {TR_FIGURE_DESC_INDIGENOUS_NATIVE, "Indigenous native"},
    {TR_FIGURE_DESC_NATIVE_TRADER, "Native trader"},
    {TR_FIGURE_DESC_WOLF, "Wolf"},
    {TR_FIGURE_DESC_SHEEP, "Sheep"},
    {TR_FIGURE_DESC_ZEBRA, "Zebra"},
    {TR_FIGURE_DESC_ENEMY, "Enemy"},
    {TR_FIGURE_DESC_ARROW, "Arrow"},
    {TR_FIGURE_DESC_MAP_FLAG, "Map flag"},
    {TR_FIGURE_DESC_EXPLOSION, "Explosion"},
    {TR_CLIMATE_NORTHERN, "Northern provinces"},
    {TR_CLIMATE_CENTRAL, "Central provinces"},
    {TR_CLIMATE_DESERT, "Desert provinces"},
};
