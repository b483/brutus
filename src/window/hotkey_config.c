...
static hotkey_widget hotkey_widgets[] = {
    ...
    {HOTKEY_CENTER_WINDOW, TR_HOTKEY_CENTER_WINDOW, 0, 0},
    {HOTKEY_RESIZE_TO_640, TR_HOTKEY_RESIZE_TO_640, 0, 0},
    {HOTKEY_RESIZE_TO_800, TR_HOTKEY_RESIZE_TO_800, 0, 0},
    {HOTKEY_RESIZE_TO_1024, TR_HOTKEY_RESIZE_TO_1024, 0, 0},
    ...
    {HOTKEY_HEADER, TR_HOTKEY_HEADER_ADVISORS, 0, 0},
    {HOTKEY_SHOW_ADVISOR_LABOR, TR_HOTKEY_SHOW_ADVISOR_LABOR, 0, 0},
    {HOTKEY_SHOW_ADVISOR_MILITARY, TR_HOTKEY_SHOW_ADVISOR_MILITARY, 0, 0},
    {HOTKEY_SHOW_ADVISOR_IMPERIAL, TR_HOTKEY_SHOW_ADVISOR_IMPERIAL, 0, 0},
    {HOTKEY_SHOW_ADVISOR_RATINGS, TR_HOTKEY_SHOW_ADVISOR_RATINGS, 0, 0},
    {HOTKEY_SHOW_ADVISOR_TRADE, TR_HOTKEY_SHOW_ADVISOR_TRADE, 0, 0},
    {HOTKEY_SHOW_ADVISOR_POPULATION, TR_HOTKEY_SHOW_ADVISOR_POPULATION, 0, 0},
    {HOTKEY_SHOW_ADVISOR_HEALTH, TR_HOTKEY_SHOW_ADVISOR_HEALTH, 0, 0},
    {HOTKEY_SHOW_ADVISOR_EDUCATION, TR_HOTKEY_SHOW_ADVISOR_EDUCATION, 0, 0},
    {HOTKEY_SHOW_ADVISOR_ENTERTAINMENT, TR_HOTKEY_SHOW_ADVISOR_ENTERTAINMENT, 0, 0},
    {HOTKEY_SHOW_ADVISOR_RELIGION, TR_HOTKEY_SHOW_ADVISOR_RELIGION, 0, 0},
    {HOTKEY_SHOW_ADVISOR_FINANCIAL, TR_HOTKEY_SHOW_ADVISOR_FINANCIAL, 0, 0},
    {HOTKEY_SHOW_ADVISOR_CHIEF, TR_HOTKEY_SHOW_ADVISOR_CHIEF, 0, 0},
    {HOTKEY_HEADER, TR_HOTKEY_HEADER_OVERLAYS, 0, 0},
    {HOTKEY_TOGGLE_OVERLAY, TR_HOTKEY_TOGGLE_OVERLAY, 0, 0},
