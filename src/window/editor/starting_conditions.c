...
static void draw_foreground(void)
{
    ...
    // Initial funds
    lang_text_draw(44, 39, 32, 205, FONT_NORMAL_BLACK);
    button_border_draw(262, 196, 200, 30, focus_button_id == 4);
    text_draw_number_centered(scenario_initial_funds(), 262, 205, 200, FONT_NORMAL_BLACK);

    // Rescue loan
    lang_text_draw(44, 68, 32, 245, FONT_NORMAL_BLACK);
    ...
    // Rome supplies wheat?
    lang_text_draw(44, 43, 32, 325, FONT_NORMAL_BLACK);
    button_border_draw(262, 316, 200, 30, focus_button_id == 7);
    lang_text_draw_centered(18, scenario_property_rome_supplies_wheat(), 262, 325, 200, FONT_NORMAL_BLACK);

    // Flotsam on?
    lang_text_draw(44, 80, 32, 365, FONT_NORMAL_BLACK);
    button_border_draw(262, 356, 200, 30, focus_button_id == 8);
    lang_text_draw_centered(18, scenario_map_has_flotsam(), 262, 365, 200, FONT_NORMAL_BLACK);

    // Milestone - 25%
    lang_text_draw(44, 91, 32, 405, FONT_NORMAL_BLACK);
    button_border_draw(262, 396, 200, 30, focus_button_id == 9);
    int width = text_draw_number(scenario_editor_milestone_year(25), '+', " ", 297, 407, FONT_NORMAL_BLACK);
    lang_text_draw_year(scenario_property_start_year() + scenario_editor_milestone_year(25),
        307 + width, 407, FONT_SMALL_PLAIN);

    // Milestone - 50%
    lang_text_draw(44, 92, 32, 445, FONT_NORMAL_BLACK);
    button_border_draw(262, 436, 200, 30, focus_button_id == 10);
    width = text_draw_number(scenario_editor_milestone_year(50), '+', " ", 297, 447, FONT_NORMAL_BLACK);
    lang_text_draw_year(scenario_property_start_year() + scenario_editor_milestone_year(50),
        307 + width, 447, FONT_SMALL_PLAIN);

    // Milestone - 75%
    lang_text_draw(44, 93, 32, 485, FONT_NORMAL_BLACK);
    button_border_draw(262, 476, 200, 30, focus_button_id == 11);
    width = text_draw_number(scenario_editor_milestone_year(75), '+', " ", 297, 487, FONT_NORMAL_BLACK);
    lang_text_draw_year(scenario_property_start_year() + scenario_editor_milestone_year(75),
        307 + width, 487, FONT_SMALL_PLAIN);

    // Right-click to Continue
    lang_text_draw_centered(13, 3, 12, 512, 480, FONT_NORMAL_BLACK);
