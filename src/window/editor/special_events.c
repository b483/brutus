...
static void draw_foreground(void)
{
    ...
    button_border_draw(200, 134, 75, 24, focus_button_id == 5);
    ...
    button_border_draw(200, 164, 75, 24, focus_button_id == 6);
    ...
    button_border_draw(200, 194, 75, 24, focus_button_id == 7);
    ...
    button_border_draw(200, 224, 75, 24, focus_button_id == 8);
