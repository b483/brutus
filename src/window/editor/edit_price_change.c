...
{
    if (generic_buttons_handle_mouse(mouse_in_dialog(m), 0, 0, buttons_edit_price_change, sizeof(buttons_edit_price_change) / sizeof(struct generic_button_t), &data.focus_button_id)) {
        return;
    }
