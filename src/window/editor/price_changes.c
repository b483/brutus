...
{
    if (generic_buttons_handle_mouse(mouse_in_dialog(m), 0, 0, buttons_price_changes, sizeof(buttons_price_changes) / sizeof(struct generic_button_t), &focus_button_id)) {
        return;
    }
